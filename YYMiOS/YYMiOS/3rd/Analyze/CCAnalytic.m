...
//  insw-c-ios-iphone
//
//  Created by lixiaosong on 12-8-13.
//  Copyright (c) 2012年 猎聘网. All rights reserved.
//

#import "CCAnalytic.h"

@implementation CCAnalytic
/*
...
+ (NSString *)getFlurryAgentVersion{
    return @"1";
}// get the Flurry Agent version number
+ (void)setShowErrorInLogEnabled:(BOOL)value{
	
}// default is NO
+ (void)setDebugLogEnabled:(BOOL)value{
    
}// generate debug logs for Flurry support, default is NO
+ (void)setSessionContinueSeconds:(int)seconds{
    
}// default is 10 seconds
+ (void)setSecureTransportEnabled:(BOOL)value{
    
}// set data to be sent over SSL, default is NO
...
}// manually increment page view by 1
