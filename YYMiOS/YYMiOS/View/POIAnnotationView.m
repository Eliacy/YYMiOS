...
- (void)setPoi:(POI *)poi
{
    ...
    {
        _levelImageView.frame = CGRectMake(_backView.frame.size.width - 8 - 15, _levelImageView.frame.origin.y, 15, 15);
        _levelImageView.image = [UIImage imageNamed:@"rank_S.png"];
    }
    else if(poi.level && [poi.level isEqualToString:@"SS"])
    {
        _levelImageView.frame = CGRectMake(_backView.frame.size.width - 8 - 31, _levelImageView.frame.origin.y, 31, 15);
