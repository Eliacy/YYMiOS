...
#define ORIGINAL_MAX_WIDTH 1000.0
...
+ (UIImage *)imageByScalingToMaxSize:(UIImage *)sourceImage {
    ...
    return [LPUtility imageByScalingAndCroppingForSourceImage:sourceImage targetSize:targetSize];
}
...
//                                                                  QNUploadOption *opt = [[QNUploadOption alloc] initWithMime:@"image/png" progressHandler:nil params:nil checkCrc:YES cancellationSignal:nil];
                                                                  ...
                                                                  NSData *uploadData = UIImageJPEGRepresentation([LPUtility imageByScalingToMaxSize:image], 0.8);
